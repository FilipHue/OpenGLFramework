#include "demo_spotlight.h"

DemoSpotlight::DemoSpotlight()
{
}

void DemoSpotlight::Init()
{
...
void DemoSpotlight::Update(double delta_time)
{
...
void DemoSpotlight::EndFrame()
{
}

void DemoSpotlight::OnInputUpdate(double delta_time, int mods)
{
}

void DemoSpotlight::OnKeyPress(int key, int mods)
{
}

void DemoSpotlight::OnKeyRelease(int key, int mods)
{
}

void DemoSpotlight::OnMouseMove(double x_pos, double y_pos, double delta_x, double delta_y)
{
}

void DemoSpotlight::OnMouseButtonPress(double x_pos, double y_pos, int key, int mods)
{
}

void DemoSpotlight::OnMouseButttonRelease(double x_pos, double y_pos, int key, int mods)
{
}

void DemoSpotlight::OnMouseScroll(double x_offset, double y_offset)
{
}
